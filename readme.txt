...
= 10.3 =
* Patch mysql error on the crontab
= 10.2 =
* Important bug patch subdirectory wordpress
= 10.1 =
* IMPORTANT ! patch bug dashboard
= 10.0 =
* Translate english and french
* Design and menu
* check smtp server
= 9.9 =
* Delete secondary editor for js incompatibility
= 9.8 =
* Update crontab
= 9.7 =
* Delete dir
