...
(function($) {
  ...
  $.fn.HAtable = function(sortFns) {
    return this.each(function() {
      var $table = $(this);
      sortFns = sortFns || {};

      // Merge sort functions with some default sort functions.
      sortFns = $.extend({}, $.fn.HAtable.default_sort_fns, sortFns);
      ...
      $table.on("click.HAtable", "th", function() {
        var $this = $(this);
        var th_index = 0;
        var dir = $.fn.HAtable.dir;
  ...
  $.fn.HAtable.dir = {ASC: "asc", DESC: "desc"};

  $.fn.HAtable.default_sort_fns = {
    "int": function(a, b) {
